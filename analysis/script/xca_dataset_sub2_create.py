...
for userId in os.listdir(folder_path):
    ...
    for videoId in videoId_list:
            ...
            if len(videoId.split("CATH"))==1:
                ...
                dest_path = os.path.join(folder2_path+"/"+userId+"/images",videoId)
                ...
                dest_path = os.path.join(folder2_path+"/"+userId+"/ground_truth",videoId)
                for frameId in os.listdir(source_path):
                    copy_file_contents(
                        os.path.join(source_path, frameId), 
                        dest_path, 
                ...
                dest_path = os.path.join(folder2_path+"/"+userId+"/ground_truth_CATH",videoId+"CATH")
                for frameId in os.listdir(source_path):
                    copy_file_contents(
                        os.path.join(source_path, frameId), 
                        dest_path, 
