...
from free_cos.network.ContrastiveHead_myself import ContrastiveHead_myself
from free_cos.network.conv_block import conv_block
...
class UNet_contrast(nn.Module):
    ...
    def __init__(self, n_channels, n_classes): # 通道=4,分类=1
        ...
        if False:#config.contrast["weight"]>0:
