...
# def main(): 
    ...
    configs = [#在短视频数据上的测试结果
        ...
        #         "epochs":0.3,#0.625,#欠拟合和过拟合都没太大差别
        ...
        #         "de-soft":None,
        #     },
        #     "name": "A27-02", #提高模型的拟合能力
        #     "precomputed": False,
        #     "noise_label":"A27-02.rigid",
        #     "input_mode": "A27-02.rigid.non1",
        ...
        #         "de-soft":None,
        #     },
        #     "name": "A27-03", #提高模型的拟合能力
        #     "precomputed": False,
        #     "noise_label":"A27-03.rigid",
        #     "input_mode": "A27-03.rigid.non1",
        #     "norm_method": norm_calculator.calculate_mean_variance,
        #     "binarize": True,
        #     "inferenceAll": False,#True,#
        #     "mergeMask": False,
        ...
        #                 "dynamicTex":True,#动态纹理 #用于兼容layer2类接口
        #                 "hidden_layers_map": 4, 
        #                 "hidden_features_map": 256,#64,#8,#256,#3*256,#7*256, 
        #                 "posEnc":{ # 有显著作用
        #                     "num_freqs_pos":10, #3
        #                     "num_freqs_time":100,#*2,#5, #4, #1 #后面要通过这里测试时序编码能否提升效果
        #                     "APE":False, #没有启用渐进式位置编码、启用不是改为True
        ...
        #         "de-soft":None,
        #     },
        #     "name": "A27-04", #提高模型的拟合能力
        #     "precomputed": False,
        #     "noise_label":"A27-04.rigid",
        #     "input_mode": "A27-04.rigid.non1",
        #     "norm_method": norm_calculator.calculate_mean_variance,
        #     "binarize": True,
        #     "inferenceAll": False,#True,#
        #     "mergeMask": False,
        ...
        #         "de-soft":None,
        #     },
        #     "name": "A27-05", #提高模型的拟合能力
        #     "precomputed": False,
        #     "noise_label":"A27-05.rigid",
        #     "input_mode": "A27-05.rigid.non1",
        #     "norm_method": norm_calculator.calculate_mean_variance,
        #     "binarize": True,
        #     "inferenceAll": False,#True,#
        #     "mergeMask": False,
        ...
        #                 "dynamicTex":False, #动态纹理
        #                 'hidden_layers_map':2,#1,#2,#4,#32,#4,
        #                 'hidden_features_map': 512,#8*512,#256,#64,#8,#2*4*512,#16*4*512,#128,#512, #128,
        #                 "posEnc":False,
        #                 "use_featureMask":False,
        #             },
        #         }, 
        ...
        #                 "hidden_features_map": 8*512,#256,#64,#8,#256,#3*256,#7*256, 
        #                 "posEnc":{ # 有显著作用
        #                     "num_freqs_pos":10, #3
        #                     "num_freqs_time":100,#*2,#5, #4, #1 #后面要通过这里测试时序编码能否提升效果
        #                     "APE":False, #没有启用渐进式位置编码、启用不是改为True
        ...
        #         "de-soft":None,
        #     },
        #     "name": "A27-06", #提高模型的拟合能力
        #     "precomputed": False,
        #     "noise_label":"A27-06.rigid",
        #     "input_mode": "A27-06.rigid.non1",
        #     "norm_method": norm_calculator.calculate_mean_variance,
        #     "binarize": True,
        #     "inferenceAll": False,#True,#
        #     "mergeMask": False,
        ...
        #                 "dynamicTex":True,#动态纹理 #用于兼容layer2类接口
        #                 "hidden_layers_map": 2,#4, 
        #                 "hidden_features_map": 4*512,#256,#64,#8,#256,#3*256,#7*256, 
        #                 "posEnc":{ # 有显著作用
        #                     "num_freqs_pos":10, #3
        #                     "num_freqs_time":100,#*2,#5, #4, #1 #后面要通过这里测试时序编码能否提升效果
        #                     "APE":False, #没有启用渐进式位置编码、启用不是改为True
        ...
        #         "de-soft":None,
        #     },
        #     "name": "A27-07", #提高模型的拟合能力
        #     "precomputed": False,
        #     "noise_label":"A27-07.rigid",
        #     "input_mode": "A27-07.rigid.non1",
        #     "norm_method": norm_calculator.calculate_mean_variance,
        #     "binarize": True,
        #     "inferenceAll": False,#True,#
        #     "mergeMask": False,
        ...
        { #follow 25: 测试关闭‘渐进式网络结构’效果是否会更差
            ...
            "name": "A27-08", #提高模型的拟合能力
            "precomputed": False,
            "noise_label":"A27-08.rigid",
            "input_mode": "A27-08.rigid.non1",
            "norm_method": norm_calculator.calculate_mean_variance,
            "binarize": True,
            "inferenceAll": False,#True,#
            "mergeMask": False,
        ...
        #         #"total_steps":2000,#1000,#"epoch":1000,#2000,#2000,#6000,#4000,#2000,          #只兼容了startDecouple1 #recon_all=0.00011
        #         "epochs":0.625,#
        #         "batch_size_scale":1, #1/8,#1.5,#2*2*1/8, #之前是8个batch一帧，现在是1个batch为1帧 #训练速度提高16倍
        #         "dynamicVesselMask":{#有较长的时间开销
        #             # "startEpoch":1000*10,
        #             # "intervalEpoch":3000,#300,
        #             "startStep":0.5*10,
        ...
        #         "de-soft":None,
        #     },
        #     "name": "A26-05", #提高模型的拟合能力
        #     "precomputed": False,
        #     "noise_label":"A26-05.rigid",
        #     "input_mode": "A26-05.rigid.non1",
        #     "norm_method": norm_calculator.calculate_mean_variance,
        #     "binarize": True,
        #     "inferenceAll": True,#False,
        #     "mergeMask": False,
