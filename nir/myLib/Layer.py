    ...
    def __init__(self, # useGlobal=True, useLocal=True,  useMatrix=True, #废弃
        ...
        if use_dynamicFeatureMask:
            ...
            self.kFeatureMask_motion = LearnableVariable(
                0 if init_dynamicFeatureMask is None else init_dynamicFeatureMask
            ...
            self.kFeatureMask_texture = LearnableVariable(1) #nn.Parameter(torch.tensor(1, dtype=torch.float32).cuda())
