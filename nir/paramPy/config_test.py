...
'''
config_A26_03_01P15_old={ # follow: onfig_A26_03_01P13
            "decouple":{ # 解耦
                "tag":"A26_03_01P15_5",
                "de-rigid":"1_sim",#去噪框架
...
config_test_old={ # follow: onfig_A26_03_01P13
            "decouple":{ # 解耦
                "tag":"A26_03_01P15_9",
                "de-rigid":"1_sim",#去噪框架
                #"total_steps":2000,#1000,#"epoch":1000,#2000,#2000,#6000,#4000,#2000, #只兼容了startDecouple1 #recon_all=0.00011
                ...
                "lossFunType":{ #无法只拟合血管 #"MSE", "myLog", "atten_d"
                    ...
                    "rm":"MSE_noUL", #背景更清晰一些
                    "rv":"myLog",#"MSE", #更模糊一些 #myLog对于很暗的地方非常敏感
                    "rv_eps":0.25,#0.5,#0,#0.1,#0.5,#0.1,#该参数的效果还没有被测试 #训练不足
                    "vesselMask_eps":1,#0.1,#0.25,
                }, 
                "UncertainLearning":{
                    "use":True,#False,#False,#True,
            ...
            "name": "A26_03_01P15_9", #提高模型的拟合能力
            "precomputed": False,
            "noise_label":"A26_03_01P15_9.rigid",
            "input_mode": "A26_03_01P15_9.rigid.non1",
            "binarize": True,
            "inferenceAll": True,#False,
            "mergeMask": False,
        }
config_test_old2={ # follow: config_A26_03_01P15
            "decouple":{ # 解耦
                "tag":"A26_03_01P15",
                "de-rigid":"1_sim",#去噪框架
                #"total_steps":2000,#1000,#"epoch":1000,#2000,#2000,#6000,#4000,#2000, #只兼容了startDecouple1 #recon_all=0.00011
                ...
                "configRigids":{ # 整个刚体层模块的参数
                    "layer":{
                        ...
                        "posEnc":{ 
                            "num_freqs_pos":0, #3
                            "num_freqs_time":0, #4, #1 #后面要通过这里测试时序编码能否提升效果
                            "APE":False,
                        }, 
                        "use_featureMask":False,
                    },
                ...
                # 1.2 软体模块
                "NUM_soft":1,
                "motionSuperposition":False, #是否将刚体层的整体运动叠加到软体层上,默认是True
                "configSofts":{ # 软体
                    "layer":{
                        "use_residual":{
                            "R":False,
                ...
                # 2.损失函数
                "useSmooth":False,#8,#True,#False, #不进行平滑约束
                ...
                ########################
                "de-soft":None,
                "saveTempImg":True,#False,#True,#False,#True,
            },
...
config_test={ # follow: config_A26_03_01I2
            "decouple":{ # 解耦
                "tag":"A26-03-01I2",
                "de-rigid":"1_sim",#去噪框架
                #"total_steps":2000,#1000,#"epoch":1000,#2000,#2000,#6000,#4000,#2000, #只兼容了startDecouple1 #recon_all=0.00011
