'''
    ...
    分析一下：
        失败
    实验设备: 
        AutoDL_P和O、DeNVeR.26-3_new
    Running time: [(111/109)*8*2.132749098870489 hours]
'''
config_A26_03_01R13={ # follow: config_A26_03_01R
            "decouple":{ # 解耦
                "tag":"A26-03-01R13",
                "de-rigid":"1_sim",#去噪框架
            ...
            "name": "A26-03-01R13", #提高模型的拟合能力
            "precomputed": False,
            "noise_label":"A26-03-01R13.rigid",
            "input_mode": "A26-03-01R13.rigid.non1",
