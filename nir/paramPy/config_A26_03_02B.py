'''
    ...
    Running time: 14.35880614048905 hours
    ECLU:
        分为两部分,
            一部分是渐进式ECLU: 
                只作用于流体
            ...
            另外一部分是动态ECLU: 
                ...
                这个测试没有启用
'''
config_A26_03_02B={ #follow 25: 测试动态血管遮挡
            "decouple":{ # 解耦
                "tag":"A26-03-02B",
                "de-rigid":"1_sim",#去噪框架
            ...
            "name": "A26-03-02B", #提高模型的拟合能力
            "precomputed": False,
            "noise_label":"A26-03-02B.rigid",
            "input_mode": "A26-03-02B.rigid.non1",
