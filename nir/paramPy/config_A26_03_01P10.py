'''
    ...
    Running time: ?? hours
'''
config_A26_03_01P10={ # follow:config_A26_03_01P9
            "decouple":{ # 解耦
                "tag":"A26_03_01P10",
                "de-rigid":"1_sim",#去噪框架
                ...
                "UncertainLearning":{
                    ...
                    "activationFunction":"square",#{None :不使用激活函数, "softplus": 软Relu ,"square" :平方, "sigmoid2"}
            ...
            "name": "A26_03_01P10", #提高模型的拟合能力
            "precomputed": False,
            "noise_label":"A26_03_01P10.rigid",
            "input_mode": "A26_03_01P10.rigid.non1",
            "binarize": True,
