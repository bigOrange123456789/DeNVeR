'''
    内容：
        ...
        修改点:
            ...
            新增参数：
                "SN_D":[1.00,0.50,0.25],#多level自适应训练 #这几个数值必须从大到小排列
                "SN_D_config":{
                    "interval":5, #间隔
                    "starting":0,
                    "ending":50, #关闭位置
...
config_A26_03_SN_D={ # follow: config_A26_03_01I2
            "decouple":{ # 解耦
                ...
                "use_dynamicFeatureMask":True,#False,#True,
                "init_dynamicFeatureMask":1.0, #遮挡向量的的初始值为1
            ...
            "name": "A26_03_SN_D", #提高模型的拟合能力
            "precomputed": False,
            "noise_label":"A26_03_SN_D.rigid",
            "input_mode": "A26_03_SN_D.rigid.non1",
