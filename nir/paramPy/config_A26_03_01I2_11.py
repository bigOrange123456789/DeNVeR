'''
    ...
    结果：
        ?
    实验设备: 
        AutoDL_K、DeNVeR.26-3_new
    Running time: 3*4.68600740439362 hours
'''
config_A26_03_01I2_11={ # follow: config_A26_03_01I2
            "decouple":{ # 解耦
                "tag":"A26-03-01I2_11",
                "de-rigid":"1_sim",#去噪框架
            ...
            "name": "A26-03-01I2_11", #提高模型的拟合能力
            "precomputed": False,
            "noise_label":"A26-03-01I2_11.rigid",
            "input_mode": "A26-03-01I2_11.rigid.non1",
