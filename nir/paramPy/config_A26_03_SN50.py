    ...
    内容：
        ...
        修改点:
            ...
            修改初始遮挡程度：
                ...
                "init_dynamicFeatureMask":0.50, #遮挡向量的的初始值为1
    目标：
        ??
    结果：
        ??
    实验设备: 
        AutoDL_D (RTX 3090(24GB) * 4)、DeNVeR.26-3_new
    Running time: ?? hours 
'''
config_A26_03_SN50={ # follow: config_A26_03_01I2
            "decouple":{ # 解耦
                "tag":"A26_03_SN50",
                "de-rigid":"1_sim",#去噪框架
            ...
            "name": "A26_03_SN50", #提高模型的拟合能力
            "precomputed": False,
            "noise_label":"A26_03_SN50.rigid",
            "input_mode": "A26_03_SN50.rigid.non1",
