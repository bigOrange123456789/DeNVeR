'''
    ...
    结果：
        1I2_6-CATH:
            Dice:        0.7879 ± 0.0941
            Recall:      0.8100 ± 0.1115
            Precision:   0.7759 ± 0.1007
    实验设备: 
        AutoDL_E、DeNVeR.26-3_new
    Running time: 5*2.950474018322097 hours
'''
config_A26_03_01I2_6={ # follow: config_A26_03_01I2
            "decouple":{ # 解耦
                "tag":"A26-03-01I2_6",
                "de-rigid":"1_sim",#去噪框架
            ...
            "name": "A26-03-01I2_6", #提高模型的拟合能力
            "precomputed": False,
            "noise_label":"A26-03-01I2_6.rigid",
            "input_mode": "A26-03-01I2_6.rigid.non1",
