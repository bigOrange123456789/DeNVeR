config_rigid12={ #test12 最终采用了12号运动#流体层进行渐进式学习 #有一个较好的效果
            "decouple":{ # 解耦
                ...
                "lossFunType":{ #无法只拟合血管 #"MSE", "myLog", "atten_d"
                    "ra":"MSE",
                    "rm":"MSE",#"myLog",#"MSE", #背景更清晰一些
                    "rv":"MSE",#"myLog",#"MSE", #更模糊一些
            ...
            "norm_method": None,#norm_calculator.calculate_mean_variance,
            "binarize": True,
