'''
    ...
    目标：
        ...
        期望能超过实验G就成功了、但我不确定是否能实现
    结果：
        基本和G持平了、并且代码方案更加合理(缺点是训练时间多2个小时)
    实验设备: 
        AutoDL_L、DeNVeR.26-3_new
    Running time: 7.99 = 6.335704752604166*111/88 hours
'''
config_A26_03_01I={ # follow: config_A26_03_**
            "decouple":{ # 解耦
                "tag":"A26-03-01I",
                "de-rigid":"1_sim",#去噪框架
            ...
            "name": "A26-03-01I", #提高模型的拟合能力
            "precomputed": False,
            "noise_label":"A26-03-01I.rigid",
            "input_mode": "A26-03-01I.rigid.non1",
