    ...
    configs = [#在短视频数据上的测试结果
        ...
        { #follow 25: 测试关闭‘渐进式网络结构’效果是否会更差
            ...
            "decouple":{ # 解耦
                ...
                "configRigids":{ # 整个刚体层模块的参数
                    "layer":{
                        "use_residual":{ "R":False, "S":False, "T":False },
                        # 整体运动
                        "useGlobal":False,
                        'hidden_layers_global':1,
                        'hidden_features_global':1,
            ...
            "name": "A26-01-1", #提高模型的拟合能力
            "precomputed": False,
            "noise_label":"A26-01-2.rigid",
            "input_mode": "A26-01-2.rigid.non1",
            "norm_method": norm_calculator.calculate_mean_variance,
            "binarize": True,
            "inferenceAll": True,#False,
            "mergeMask": False,
        ...
        #         "de-soft":None,
        #     },
        #     "name": "A26-02", #提高模型的拟合能力
        #     "precomputed": False,
        #     "noise_label":"A26-02.rigid",
        #     "input_mode": "A26-02.rigid.non1",
        #     "norm_method": norm_calculator.calculate_mean_variance,
        #     "binarize": True,
        #     "inferenceAll": True,#False,
        #     "mergeMask": False,
        ...
        #         "de-soft":None,
        #     },
        #     "name": "A26-04", #提高模型的拟合能力
        #     "precomputed": False,
        #     "noise_label":"A26-04.rigid",
        #     "input_mode": "A26-04.rigid.non1",
        #     "norm_method": norm_calculator.calculate_mean_variance,
        #     "binarize": True,
        #     "inferenceAll": True,#False,
        #     "mergeMask": False,
